...
export default function LoginPage() {
  ...
  function handleLogin(event: FormEvent<HTMLFormElement>) {
    ...
    /*
      ตอนนี้ยังเป็นระบบทดสอบหน้าเว็บ
    ...
    if (savedMember) {
      try {
        ...
        if (
          ...
          setError("ชื่อ-นามสกุลไม่ตรงกับบัญชีที่สมัครไว้");
          setLoading(false);
          return;
        }
      } catch {
        // ถ้าข้อมูลเดิมอ่านไม่ได้ ให้เข้าสู่ระบบทดสอบต่อ
      }
    }
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 rounded-2xl border border-blue-100 bg-blue-50 p-4 text-center">
            ...
            <p className="mt-1 text-xs leading-5 text-blue-600">
              ขณะนี้ระบบยังไม่ได้เชื่อมต่อ Supabase
              <br />
              กำลังเตรียมระบบฐานข้อมูลสมาชิก
            </p>
